...
function Card() {
    ...
    const proccess_car_data = (car_request_data: CarRequestType[]) => {
      return car_request_data.map((car_request, index) => {
        return (
          ...
          <td>
            <img className="edit-icon" src="./src/assets/Icon_editar1.svg" alt="delete-icon" onClick={()=>{handle_edit_click(car_request.car_request_id)}}  
             />
            <img className="delete-icon" src="./src/assets/Icon_eliminar1.svg" alt="delete-icon" onClick={(event)=>{handle_delete_click(car_request.car_request_id, event)}}
            />
          </td>
        </tr>
          )
 ...
 const  handleOnClickCrear =  ()=>{
  ...
  return (
    ...
    <section className="card" id="main-card">
      <div className="card-header">
        <span className="add">
          <img className="add-arrow" src="./src/assets/Icon_crear.svg" alt="add" onClick={handle_add_click} />
        </span>
      </div>
      <div className="inputs">
        <div className="input-row">
          <img id="car-icon" className="input-image" src="./src/assets/Icon_vehiculo.svg" alt="car-input" />
          <input type="text" placeholder="Mazda" id="car-id-input"/>
        </div>
        <div className="input-row">
          <img id="locality-icon" className="input-image" src="./src/assets/Icon_puntoubicacion.svg" alt="locality-input" />
          <input type="text" placeholder="Chapinero" id="card-locality-input" />
        </div>
        <div className="input-row">
          <img id="client-icon" className="input-image" src="./src/assets/Icon_persona.svg" alt="client-input" />
      ...
      <button className="cancel-btn" id="cancel-btn-id" onClick={handle_cancel_click} >
          <img src="./src/assets/Icon_cancelar.svg" alt="cancel-btn" />
        </button>
        <button className="confirm-btn" id="confirm-btn-id"  onClick={handleOnclikEdit}>
          <img src="./src/assets/Icon_confirmar.svg" alt="confirm-btn" />
        </button>
  ...
  <footer>
    <img src="./src/assets/Imagologotipo_motion.svg" alt="imagologotipo-motion" />
  </footer>
  </>
  );
